...
export default function MiniCart({ open, onClose }) {
  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            <div className="mini-cart__body custom-scrollbar">
              ...
              {cart.map((item) => (
                <div className="mini-item" key={item.cartItemId || item.variantId}>
                  ...
                  <div className="mini-item__info">
                    ...
                    <p className="mini-item__meta text-[10px] uppercase font-bold text-white/40">
                    ...
                    <div className="mini-item__actions">
                      <div className="qty-control">
                        ...
                        <button onClick={() => increaseQty(item.id, item.variantId, item.qty)}>
                          <span className="material-symbols-outlined">
                            add
                          </span>
                        </button>
      ...
      {/* Modal removed to restore old behavior */}
    </>
  );
}
